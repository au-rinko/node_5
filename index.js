...
const { showMozzarella, favoritePizzas, createTurtle, updateFat, showWeapons, addFavoritePizzas }  = require('./routes/queries');
...
app.use('/api/queries/mozzarella/', showMozzarella);
app.use('/api/queries/favoritepizza/', favoritePizzas);
